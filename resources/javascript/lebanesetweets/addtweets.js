$(function(){
	ltApp.addTweets = function(){
		...
		console.log( ltApp.webRoot + "/ajax/" + group + "/" + (ltApp.tweetsLoaded + 1) + "/" + (ltApp.tweetsLoaded + 20));

		$.get( ltApp.webRoot + "/ajax/" + group + "/" + (ltApp.tweetsLoaded + 1) + "/" + (ltApp.tweetsLoaded + 20) + search , function( data ) {
			$data = $(data);
